        ...
        >
          ...
          <div className="flex flex-col gap-8">
            ...
            <Paragraph>
              ...
              Text2Graph에서는 학습된 모델의 평가 로직을 점검해 F1을 +4.07pt
              개선했고, StructVerify-Lab에서는 도메인마다 컬럼 구조가 달라지는
              수치 팩트체크 파이프라인 전체를 단일 스크립트로 처음 구현해 팀의
              모듈화 baseline을 만들었습니다. 데이터 파이프라인을 직접
              설계하고, 모델 결과를 디버깅해 성능을 끌어올리는 경험이
              무엇보다 매력적이었습니다. 지금은 처음 입문한 동기(앱 완성)를
              넘어,{" "}
            ...
            <Paragraph>
              한국에서 가장 많은 사람들이 오가는 인천국제공항에서 다양한 국적과 성격의 승객을 응대한 경험은,
              이후 팀 프로젝트에서 자연스러운 소통의 기반이 되었습니다.
              덕분에 평균 4-5명 규모의 팀 프로젝트 5개를 큰 마찰 없이 마무리할 수 있었고,
              앞으로 다양한 배경의 동료와도 자연스럽게 녹아들 수 있을 거라 생각합니다.
            </Paragraph>
          </div>
        </motion.div>
