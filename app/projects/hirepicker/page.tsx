...
const troubles: Trouble[] = [
  {
    ...
    lesson:
      "데이터의 성격(영속 vs 세션)을 보고 저장소를 선택해야 한다는 것을 체감했습니다. 인증 토큰은 ‘관리해야 할 영속 데이터’가 아니라 ‘시간이 지나면 사라지는 게 정답인 데이터’입니다.",
  },
  {
    ...
    lesson:
      "확장성 명분의 외부 인프라 도입은 운영 조건을 다시 보고 결정해야 한다는 것을 배웠습니다. ‘유명한 기술 = 좋은 선택’이 아니라 ‘내 환경에 맞는 기술 = 좋은 선택’입니다.",
  },
  {
    ...
    lesson:
      "데이터 파이프라인은 ‘어떻게 가져올 것인가’만큼 ‘어떻게 정제하고 검증할 것인가’가 품질을 결정한다는 것을 배웠습니다.",
  },
];
  ...
  return (
    ...
    >
      ...
      <Section id="lessons" title="Lessons Learned">
        <LessonsList
          items={[
            "데이터의 성격(영속 vs 세션)을 보고 저장소를 결정해야 합니다 — 인증 토큰은 영속 데이터가 아닙니다.",
            "확장성 명분의 외부 인프라 도입은 운영 조건을 다시 보고 결정해야 합니다 — ‘유명한 기술’이 아니라 ‘내 환경에 맞는 기술’입니다.",
            "데이터 파이프라인은 ‘수집’만큼 ‘정제·검증’이 품질을 결정합니다.",
          ]}
        />
      </Section>
