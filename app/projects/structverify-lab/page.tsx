  ...
  return (
    ...
    >
      ...
      <Section id="lessons" title="Lessons Learned">
        <LessonsList
          items={[
            "동기 루프로 KOSIS·HCX를 두드리다 429를 받은 적이 있어요. 그 한 번 이후로 새 외부 API를 붙일 때 가장 먼저 배치·세마포어·재시도 자리부터 비워두고 시작하고, 동시 한도는 '내가 보내고 싶은 양'이 아니라 '외부 API가 받아주는 양'에 맞춥니다.",
            ...
            "도메인마다 컬럼이 달라지는 검증 데이터를 도메인별 테이블이 아니라 EAV로 풀어둔 결정이, 나중에 새 도메인을 받는 자리를 그대로 살려뒀습니다. 사전 정의 없이 확장 가능한 게 PoC 단계에선 큰 자산이었어요.",
