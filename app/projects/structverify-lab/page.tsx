      ...
      <Section id="lessons" title="Lessons Learned">
        <LessonsList
          items={[
            ...
            "코사인 유사도가 0.85씩 나오길래 잘 찾았다고 생각했는데, 막상 보면 단위나 연도가 어긋난 표였던 적이 여러 번입니다. 임베딩이 가깝다고 정답을 가르는 통계까지 가까운 건 아니라는 걸 그때 알았습니다. 그래서 임베딩으론 후보만 좁히고, 단위·연도·범위는 규칙으로 따로 확인합니다.",
