  ...
  return (
    ...
    >
      ...
      <Section id="lessons" title="Lessons Learned · 다음 시도">
        <LessonsList
          items={[
            "RAG만 붙이면 정답률이 오를 줄 알았는데, 측정해 보니 오히려 2.3pt가 떨어졌습니다. 'RAG가 도움이 되는지'는 켜기 전에 retrieval recall@k부터 재고, 그 점수가 LLM 단독보다 의미 있게 높을 때만 붙이는 게 다음 라운드의 기본입니다.",
            "코사인 점수가 높길래 잘 찾았다고 생각했는데, 정작 모델은 그 chunk에 끌려가서 오답이 더 늘었습니다. 임베딩이 가깝다는 건 주제가 가깝다는 뜻일 뿐, 정답을 가르는 chunk가 가깝다는 보장은 아니었습니다. 그 뒤로는 검색 단계에 도메인 규칙이나 리랭커 한 층을 더 둡니다.",
