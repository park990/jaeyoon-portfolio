  ...
  return (
    ...
    >
      ...
      <Section id="lessons" title="Lessons Learned">
        <LessonsList
          items={[
            "단일 서버·HttpSession·MyBatis 같은 가장 단순한 형태로 끝까지 가보고 나니, ‘왜 분리하고 왜 무상태로 가는지’가 다음 프로젝트에서 훨씬 또렷한 결정 근거로 남았다.",
            "프론트/백 분리, 무상태 토큰, 연결 테이블 정합성 같은 표현은 책으로 읽을 땐 그냥 좋은 말이었는데, 직접 빌드 사이클·세션 끊김·다대다 불일치를 며칠 겪고 나서야 같은 문장이 다르게 읽혔다.",
          ]}
        />
      </Section>
